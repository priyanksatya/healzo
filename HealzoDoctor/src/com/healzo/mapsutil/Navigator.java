...
import com.healzo.net.TalkbackRoute;
...
public class Navigator {
	...
	private int pathColor = 0xFF07A98E;
	private int pathBorderColor = Color.LTGRAY;
	private int secondPath = 0x5007A98E;
	private int thirdPath = Color.RED;
	private float pathWidth = 15;
	...
	public Navigator(GoogleMap map, TalkbackRoute tr,String startLocation, String endLocation){
		this.startLocation = startLocation;
		this.endLocation = endLocation;
		this.startLocation=this.startLocation.replace(" ", "%20");
		this.endLocation=this.endLocation.replace(" ", "%20");
		this.map = map;
		this.tr=tr;
	}
